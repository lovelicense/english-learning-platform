...
const patternTemplates: PatternTemplateSeed[] = [
  ...
  { categoryCode: 'request', templateText: 'Can I get ~?', meaningKo: '(주문/요청) ~ 주실래요?', usageNote: '주문/구어체 요청', exampleEn: 'Can I get a coffee?', exampleKo: '커피 한 잔 주실래요?' },
  ...
  { categoryCode: 'request', templateText: "I'd like to ~.", meaningKo: '~하고 싶어요.', usageNote: '공손한 의지/주문 표현', exampleEn: "I'd like to order now.", exampleKo: '지금 주문하고 싶어요.' },
  ...
  { categoryCode: 'request', templateText: 'Do you mind ~ing?', meaningKo: '(공손한 요청) ~해도 될까요?', usageNote: '정중한 부탁', exampleEn: 'Do you mind opening the window?', exampleKo: '창문 좀 열어도 될까요?' },
  { categoryCode: 'request', templateText: 'I need you to ~.', meaningKo: '네가 ~해줬으면 해.', usageNote: '상대 행동 요청', exampleEn: 'I need you to wait.', exampleKo: '네가 조금만 기다려 줬으면 해.' },
  { categoryCode: 'request', templateText: 'I just wanted to ~.', meaningKo: '그냥 ~하고 싶었어.', usageNote: '부드럽게 말문 열기', exampleEn: 'I just wanted to say thank you.', exampleKo: '그냥 고맙다고 말하고 싶었어.' },
  { categoryCode: 'request', templateText: 'I was wondering if ~.', meaningKo: '혹시 ~인지 궁금해서요.', usageNote: '정중한 질문/요청', exampleEn: 'I was wondering if you could help.', exampleKo: '혹시 도와줄 수 있나 해서요.' },
  ...
  { categoryCode: 'clarification', templateText: "That's what I mean.", meaningKo: '그게 바로 내 말이야.', usageNote: '의미 재확인/강조', exampleEn: "That's what I mean.", exampleKo: '내 말이 바로 그 말이야.' },
  ...
  { categoryCode: 'basic_info', templateText: 'There is ~.', meaningKo: '~가 있다.', usageNote: '단수 존재 표현', exampleEn: 'There is a problem.', exampleKo: '문제가 하나 있어.' },
  { categoryCode: 'basic_info', templateText: 'There are ~.', meaningKo: '~가 있다.', usageNote: '복수 존재 표현', exampleEn: 'There are two options.', exampleKo: '선택지가 두 개 있어.' },
  ...
  { categoryCode: 'opinion', templateText: "I'm not sure if ~.", meaningKo: '~인지 잘 모르겠어.', usageNote: '확신 부족', exampleEn: "I'm not sure if it works.", exampleKo: '이게 되는지 잘 모르겠어.' },
  ...
  { categoryCode: 'opinion', templateText: 'It feels like ~.', meaningKo: '~처럼 느껴져.', usageNote: '감각적 느낌', exampleEn: 'It feels like summer.', exampleKo: '여름처럼 느껴져.' },
  { categoryCode: 'opinion', templateText: 'It looks like ~.', meaningKo: '~인 것 같아.', usageNote: '시각적 판단', exampleEn: 'It looks like rain.', exampleKo: '비 올 것 같아.' },
  { categoryCode: 'opinion', templateText: 'It sounds like ~.', meaningKo: '~처럼 들려.', usageNote: '청각적/상황적 판단', exampleEn: 'It sounds like a plan.', exampleKo: '그거 좋은 생각 같네.' },
  { categoryCode: 'opinion', templateText: 'As far as I know, ~.', meaningKo: '내가 아는 바로는 ~.', usageNote: '알고 있는 범위에서 설명', exampleEn: 'As far as I know, he left.', exampleKo: '내가 알기로 그는 떠났어.' },
  ...
  { categoryCode: 'reason', templateText: 'The thing is ~.', meaningKo: '문제는 / 사실은 ~.', usageNote: '상황 설명 시작', exampleEn: 'The thing is I am busy today.', exampleKo: '실은 내가 오늘 좀 바빠.' },
  ...
  { categoryCode: 'suggestion', templateText: 'I think you should ~.', meaningKo: '~하는 게 좋을 것 같아.', usageNote: '직접적인 조언', exampleEn: 'I think you should try it.', exampleKo: '그거 한번 해보는 게 좋을 것 같아.' },
  ...
  { categoryCode: 'scheduling', templateText: "I'll let you know ~.", meaningKo: '알려줄게.', usageNote: '후속 전달 약속', exampleEn: "I'll let you know later.", exampleKo: '나중에 알려줄게.' },
  ...
  { categoryCode: 'intention_plan', templateText: "I'm supposed to ~.", meaningKo: '~하기로 되어 있어.', usageNote: '예정/의무', exampleEn: "I'm supposed to be there now.", exampleKo: '지금 거기 가 있어야 해.' },
  ...
  { categoryCode: 'intention_plan', templateText: "I'm here to ~.", meaningKo: '~하러 왔어.', usageNote: '방문 목적 설명', exampleEn: "I'm here to help you.", exampleKo: '너 도와주러 왔어.' },
  { categoryCode: 'intention_plan', templateText: "I've been ~ing.", meaningKo: '그동안 쭉 ~해왔어.', usageNote: '지속 동작/상태', exampleEn: "I've been waiting for you.", exampleKo: '계속 널 기다리고 있었어.' },
  ...
  { categoryCode: 'intention_plan', templateText: 'I was about to ~.', meaningKo: '막 ~하려던 참이었어.', usageNote: '바로 직전 과거 계획', exampleEn: 'I was about to call you.', exampleKo: '막 전화하려던 참이었어.' },
  ...
  { categoryCode: 'feelings', templateText: "I can't wait to ~.", meaningKo: '~하는 게 너무 기대돼.', usageNote: '강한 기대감', exampleEn: "I can't wait to see you.", exampleKo: '널 만나는 게 너무 기대돼.' },
  ...
  { categoryCode: 'refusal', templateText: "I didn't mean to ~.", meaningKo: '~하려던 의도는 아니었어.', usageNote: '의도치 않았음을 설명', exampleEn: "I didn't mean to hurt you.", exampleKo: '널 아프게 하려던 건 아니었어.' },
  ...
  { categoryCode: 'permission', templateText: "You don't have to ~.", meaningKo: '~할 필요 없어.', usageNote: '의무 없음/부담 완화', exampleEn: "You don't have to worry.", exampleKo: '걱정할 필요 없어.' },
